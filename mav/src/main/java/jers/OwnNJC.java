...
/**
 * Jersey REST client generated for REST resource:OwnFacadeREST
 * [com.mycompany.sp6.own]<br>
 * USAGE:
 * <pre>
 *        OwnNJC client = new OwnNJC();
...
public class OwnNJC {
    ...
    private static final String BASE_URI = "http://localhost:8080/sp6/webresources";

    public OwnNJC() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("com.mycompany.sp6.own");
    }
